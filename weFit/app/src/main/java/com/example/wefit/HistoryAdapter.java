...
public class HistoryAdapter extends BaseAdapter {
    ...
    public HistoryAdapter(LinkedList<History> historyData, Context historyContext) {// set a adapter to change each line of the information
        super();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        route.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(historyContext, MapDetail.class); // put the information to the mapDetail page as extra when go next page
        ...
        txt_type.setText("Type\n" + historyData.get(position).getType());//change the text from the history class
